...
#define NOTIFICATION(...) log_func(notif_log_cb, __VA_ARGS__)
...
{
	client_send_ctrl_msg(client, "221 #########################\r\n221 ##	Goodbye senpai :'(	##\r\n221 #########################" FTPVITA_EOL);
}
...
void ftpvita_set_notif_log_cb(ftpvita_log_cb_t cb)
{
	notif_log_cb = cb;
}
