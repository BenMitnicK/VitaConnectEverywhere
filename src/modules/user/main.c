...
int shellUserIsUma0Redirected(const char *blkdev, const char *blkdev2) {
  return shellKernelIsUma0Redirected(blkdev, blkdev2);
}

int shellUserRedirectUma0(const char *blkdev, const char *blkdev2) {
  return shellKernelRedirectUma0(blkdev, blkdev2);
}
